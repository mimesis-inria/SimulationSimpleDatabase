...
factory.add_markers(normal_to=0, indices=randint(0, armadillo.N(), 10),
...
for step in range(50):
    ...
    factory.update_markers(object_id=1, indices=randint(0, armadillo.N(), 10))
    factory.update_markers(object_id=2, indices=randint(0, armadillo.N(), 10))
    visualizer.render()
    sleep(0.01)
